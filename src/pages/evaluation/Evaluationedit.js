...
export default function User(props) {
    ...
    const nextdata = async () => {
        // await  sleep(2000) 
            ...
            setMultipleanswer(multipleansnext[questionindex].inputfields);
        ...
        if (allanswer.length == 0) {
            ...
            getSingleAnswer(id).then((res,row) => {
                ...
                if (res.status) {
                    ...
                    // setHint(multipleanswer[index].hint);
                                                                    ...
                                                                    <div className='editev' >
                                                                        ...
                                                                        <div className='editpart'>
                                                                            <div >
                                                                                ...
                                                                                <Form.Control type="text" value={row.hint}  onChange={(e) => setHint(e.target.value)}    ></Form.Control>
                                                                            </div>
                                                                            <div className='edittype'>
                                                                                <Form.Group controlId="exampleForm.ControlInput1" >
                                                                                    <Form.Label><h5>Type</h5></Form.Label>
                                                                                    <Form.Control type="text" value={row.type} onChange={(e) => setType(e.target.value)}    ></Form.Control>
...
onChange={event => handleChangeInput(inputField.id, event)} ></Form.Control> */}
                                                                                    <Form.Control type="text" value={row.marks} onChange={(e) => setMarks(e.target.value)}  ></Form.Control>
                                                                        ...
                                                                        <div >
                                                                            <Form.Group className="mb-3 " controlId="exampleForm.ControlInput1">
                                                                                ...
                                                                                <Form.Control type="text" name='Answer' value={row.answer} onChange={(e) => setAnswer(e.target.value)} placeholder='Answers' as="textarea" rows={5} ></Form.Control>
                                                                            </Form.Group>
